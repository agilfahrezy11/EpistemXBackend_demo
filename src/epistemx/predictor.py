...
class spectral_transformation_calcultator:
    ...
    #Function to calculate individual Index
    #List all the equation for each transformation
    def calculate_individual_index(self, image: ee.Image, index_name: str) -> ee.Image:
        ...
        try:
            if index_name == 'NDVI':
                ...
                #Tasseled Cap Transformation (The coefficient only works for Landsat 8 and 9)
                #Add more coefficient for other imageries
                tc_coeffs = ee.Array([
            ...
            return None
    #function to calculate all of the index at once
    def calculate_index(self, image: ee.Image,
        ...
        return stacked
    #Summarize the calculation by listing each index that has been calculated
